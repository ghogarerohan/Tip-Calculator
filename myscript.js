...
// var $(Percentage_Tip).val();

// function calculate (Bill_Amount,Percentage_Tip) {

//     var actual_percentage = (Percentage_Tip/100)

//     var Tip_Amount = (Bill_Amount * actual_percentage);

//     var Total = (Bill_Amount + Tip_Amount);
